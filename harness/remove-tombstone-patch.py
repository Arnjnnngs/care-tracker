...
rep("""  { v: 'v72', date: 'Sep 7, 2026', title: 'A changed answer now stays changed',""",
    ...
    points: [
      'Removing a weight or paracentesis you had corrected now clears it properly. Before, the wrong number you had replaced could come back in its place.',
      'Remove also works on older weights, and on paracentesis entries that sometimes did not take. It used to fail without telling you.',
      'History still shows what was recorded, marked Removed. A row that a correction replaced no longer has its own Remove button.'
    ] },
