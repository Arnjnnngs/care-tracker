...
rep("""  { v: 'v72', date: 'Sep 7, 2026', title: 'A changed answer now stays changed',""",
    ...
    points: [
      'Removing a weight or paracentesis you had corrected now clears it properly. Before, the number you had fixed could come back in its place.',
      'Remove also works on older readings, and on paracentesis entries that sometimes did not take. It used to fail without telling you.',
