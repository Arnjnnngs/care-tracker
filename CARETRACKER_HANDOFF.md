...
### Reminder Schedule (Central Time) — updated v40

| Time | Type | Notification |
|---|---|---|
| 8:25–8:35 AM | Scheduled | "Morning Meds Due" — Protonix, Buspirone, Paroxetine (default window) |
| Dynamic, after 8:45 AM | Scheduled (follow-up) | "Morning Meds Due" — Buspirone, Paroxetine only, fires 2h after Protonix's actual logged morning dose if that's later than the default window |
