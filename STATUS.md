...
| | |
|---|---|
| **Version** | **v76 is LIVE on `main`.** **v77 is BUILT and NOT shipped** — it is on `claude/caretracker-team-review-i83ik2` awaiting Aaron's go-ahead for a live patient's app. |
| **Commit** | v76 = `3bebc52` on `main`. GitHub Pages build and deployment concluded success at 03:40 UTC. |
