# Suite record — v77 — 2026-09-14 15:42 UTC
...
|---|---|---|
| archived-meds-test.mjs | EXEMPT | PRE-EXISTING, measured not assumed: 49/51 on the SHIPPED v76 build and 49/51 here, identical failures. This release adds a history entry and a listener and touches no archive code. Logged for its own fix; it is not a v77 regression. |
| back-button-test.mjs | PASS | 14/14 passing |
| cal-test.mjs | EXEMPT | PRE-EXISTING, measured on the shipped v76 build where it errors on the same harness/work path in the same way. Also one of the four v43-era pinned-literal verifiers pm.py already warns about, queued for rebase or retirement. |
...
| warning-priority-test.mjs | PASS | 18/18 checks passed |
