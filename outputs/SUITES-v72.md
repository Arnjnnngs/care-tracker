# Suite record — v72 — 2026-09-07 04:39 UTC
...
| daily-supersede-test.mjs | PASS | 37/37 checks passed |
| deactivate-test.mjs | FAIL | 15 passed, 19 failed, 34 checks |
...
| medsync-test.mjs | FAIL |     [iPhone-390x844] 30 chooser buttons measured; shortest "Remove" 27.00px |
...
| reason-test.mjs | FAIL | 34/41 checks passed |
...
| tour-test.mjs | FAIL |     smallest tour button @iPhone-390x844: 44.0px (close @step0) |
...
| overflow-scan.mjs | SKIPPED | --quick run; the scan must be recorded separately in RENDER-v72.md |

Failing or erroring suites: 4
